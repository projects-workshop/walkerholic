...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    ...
    @Query(value = "SELECT DISTINCT o FROM Order o LEFT JOIN FETCH o.user u LEFT JOIN FETCH o.deliveryInfo LEFT JOIN FETCH o.paymentInfo LEFT JOIN FETCH o.orderItems r LEFT JOIN FETCH r.orderItems i LEFT JOIN FETCH i.product p LEFT JOIN FETCH p.productImages m WHERE o.id=:id")
